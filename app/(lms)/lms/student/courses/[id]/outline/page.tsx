                    ...
                    <div className="w-full md:w-80 shrink-0">
                        <Card className="bg-card/90 border-border backdrop-blur-md">
                            <CardContent className="p-6 space-y-4">
                                ...
                                <EnrollButton
                                    courseId={course.id}
                                    redirectUrl={`/lms/courses/${course.id}`} // Using ID as per existing Link, but maybe slug is better? The Link used course.id
                                        ...
                                        {module.lessons?.map((lesson) => (
                                            <div key={lesson._id} className="flex items-center justify-between p-3 rounded hover:bg-accent/50 transition-colors group cursor-default">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    {/* Duration missing in DB, so hiding or placeholder */}
                                                    {/* <span className="text-xs text-gray-600">10 min</span> */}
